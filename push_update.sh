...
git commit -m "chore: release v1.2.39 - fix unit tests suite and mock definitions" || echo "Nada que comitear"
echo "Creando tag..."
git tag -a v1.2.39 -m "Release v1.2.39" || echo "El tag ya existe"
echo "Haciendo push..."
