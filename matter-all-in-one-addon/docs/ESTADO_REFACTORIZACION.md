...
> Documento vivo. Última actualización: 2026-06-21 — versión 1.2.12.
...
| Área | Estado | Implementación / Detalles en v1.2.12 |
| --- | --- | --- |
...
| **Dispositivos compuestos** | Predeterminado | Fan + Light/Switch/Sensor del mismo `device_id` se publican obligatoriamente como endpoints de un único ServerNode y comparten QR. Desde v1.2.12, **la agrupación por `device_id` está forzada** e ignora la opción global `group_by_device_id` de la UI del add-on para prevenir desactivaciones accidentales que rompan el panel. |
