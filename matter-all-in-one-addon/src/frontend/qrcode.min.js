...
`;return typeof a==`function`&&a(null,p),p}})),I=c(o((e=>{var t=l(),n=M(),r=P(),i=F();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))(),1);function L(e,t){if(!(this instanceof L))return new L(e,t);let n=typeof e==`string`?document.getElementById(e):e;this.el=n,this.options=Object.assign({width:256,height:256,colorDark:`#000000`,colorLight:`#ffffff`,correctLevel:`M`},typeof t==`string`?{text:t}:t),this.options.text&&this.makeCode(this.options.text)}return L.CorrectLevel={L:`L`,M:`M`,Q:`Q`,H:`H`},L.toString=I.toString,L.toCanvas=I.toCanvas,L.toDataURL=I.toDataURL,L.create=I.create,L.prototype.clear=function(){this.el&&(this.el.innerHTML=``)},L.prototype.makeCode=function(e){this.clear();let t={errorCorrectionLevel:this.options.correctLevel||`M`,width:this.options.width,margin:1,color:{dark:this.options.colorDark||`#000000`,light:this.options.colorLight||`#ffffff`}};return I.toString(e,Object.assign({type:`svg`},t)).then(e=>{if(this.el){this.el.innerHTML=e;let t=this.el.querySelector(`svg`);t&&(t.style.width=`100%`,t.style.height=`100%`,t.style.display=`block`)}return e}).catch(e=>{console.error(`QR Code generation error:`,e),this.el&&(this.el.textContent=`Error al generar código QR.`)})},L})();