...
export class MockMatterbridgeEndpoint {
  ...
  public createCompleteFanControlClusterServer = vi
    .fn()
    .mockImplementation(() => {
      this.createFanControlClusterServer();
    });
  public createMultiSpeedFanControlClusterServer = vi
    .fn()
    .mockImplementation(() => {
      this.createFanControlClusterServer();
    });
...
vi.mock("matterbridge", () => {
  ...
  return {
    ...
    dimmableLight: makeMockDeviceType(
      0x0101,
      "dimmableLight",
      [0x3, 0x4, 0x62, 0x6, 0x8],
    ),
    colorTemperatureLight: makeMockDeviceType(
      0x010c,
      "colorTemperatureLight",
      [0x3, 0x4, 0x62, 0x6, 0x8, 0x300],
    ),
    extendedColorLight: makeMockDeviceType(
      0x010d,
      "extendedColorLight",
      [0x3, 0x4, 0x62, 0x6, 0x8, 0x300],
    ),
    onOffPlugInUnit: makeMockDeviceType(
      0x010a,
      "onOffPlugInUnit",
      [0x3, 0x4, 0x62, 0x6],
    ),
    dimmablePlugInUnit: makeMockDeviceType(
      0x010b,
      "dimmablePlugInUnit",
      [0x3, 0x4, 0x62, 0x6, 0x8],
    ),
    ...
    temperatureSensor: makeMockDeviceType(
      0x0302,
      "temperatureSensor",
      [0x3, 0x402],
    ),
    ...
    occupancySensor: makeMockDeviceType(
      0x0107,
      "occupancySensor",
      [0x3, 0x406],
    ),
    ...
    roboticVacuumCleaner: makeMockDeviceType(
      0x0074,
    ...
    waterLeakDetector: makeMockDeviceType(
      0x007b,
      "waterLeakDetector",
      [0x3, 0x45],
    ),
