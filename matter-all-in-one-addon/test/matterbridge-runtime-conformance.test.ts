...
describe('Matterbridge 3.10.6 Runtime Conformance & Integration Tests', () => {
    ...
    platform = {
      ...
      ha: {
        ...
        hassEntities: new Map([
          ['fan.ventilador_de_sala_main_fan', { id: 'entity-fan-sala', device_id: 'device-sala' }],
          ['light.ventilador_de_sala_luz', { id: 'entity-light-sala', device_id: 'device-sala' }],
          ['fan.ventilador_visitas_main_fan', { id: 'entity-fan-visitas', device_id: 'device-visitas' }],
          ['light.ventilador_visitas_luz', { id: 'entity-light-visitas', device_id: 'device-visitas' }],
          ['fan.ventilador_de_recamara_main_fan', { id: 'entity-fan-recamara', device_id: 'device-recamara' }],
          ['light.ventilador_de_recamara_luz', { id: 'entity-light-recamara', device_id: 'device-recamara' }],
        ]),
        hassDevices: new Map([
  ...
  it('Color Temperature Clamping: clamps mireds strictly against physical limits on all paths', () => {
    ...
    const clamped = lightColor.clampMireds(outOfRangeMireds, attrs, { minMireds: 135, maxMireds: 500 });
