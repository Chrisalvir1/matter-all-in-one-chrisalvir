...
exports.isValidPerms = isValidPerms;
exports.describePerms = describePerms;
...
class Characteristic extends events_1.EventEmitter {
     ...
     * @group Characteristic Definitions
     */
    static BufferActivityCommand;
    /**
     * @group Characteristic Definitions
     */
    static BufferEventCommand;
    /**
     * @group Characteristic Definitions
     */
    static BufferEventSequenceNumber;
    /**
     * @group Characteristic Definitions
     */
    static BufferUploadCommand;
    /**
     * @group Characteristic Definitions
     */
    static ButtonEvent;
     ...
     * @group Characteristic Definitions
     */
    static CameraCapabilitiesConfiguration;
    /**
     * @group Characteristic Definitions
     */
    static CameraClientCertificate;
    /**
     * @group Characteristic Definitions
     */
    static CameraClientCertificateStatus;
    /**
     * @group Characteristic Definitions
     */
    static CameraClientCSR;
    /**
     * @group Characteristic Definitions
     */
    static CameraKey;
     ...
     * @group Characteristic Definitions
     */
    static CameraRecordingPublishingPoint;
    /**
     * @group Characteristic Definitions
     */
    static CameraZones;
     ...
     * @group Characteristic Definitions
     */
    static SelectedSessionKeepaliveConfigurationList;
    /**
     * @group Characteristic Definitions
     */
     ...
     * @group Characteristic Definitions
     */
    static SupportedAudioStreamTiers;
    /**
     * @group Characteristic Definitions
     */
     ...
     * @group Characteristic Definitions
     */
    static SupportedSessionKeepaliveConfigurationList;
    /**
     * @group Characteristic Definitions
     */
     ...
     * @group Characteristic Definitions
     */
    static SupportedVideoStreamTiers;
    /**
     * @group Characteristic Definitions
     */
    static SwingMode;
     ...
     * @group Characteristic Definitions
     */
    static WebRTCNumberOfActiveSessions;
    /**
     * @group Characteristic Definitions
     */
    static WebRTCProvideAnswer;
    /**
     * @group Characteristic Definitions
     */
    static WebRTCReoffer;
    /**
     * @group Characteristic Definitions
     */
    static WebRTCSolicitOffer;
    /**
     * @group Characteristic Definitions
     */
    static WebRTCStreamingControl;
    /**
     * @group Characteristic Definitions
     */
    static WebRTCSupportedAudioStreamTiers;
    /**
     * @group Characteristic Definitions
     */
    static WebRTCSupportedVideoStreamTiers;
    /**
     * @group Characteristic Definitions
     */
    static WebRTCUpdateSession;
    /**
     * @group Characteristic Definitions
     */
    ...
    setProps(props) {
        ...
        if (props.perms) {
            if (!isValidPerms(props.perms)) {
                this.characteristicWarning(`characteristic contains invalid permissions: ${describePerms(props.perms)}`, "error-message" /* CharacteristicWarningType.ERROR_MESSAGE */, undefined, true);
            }
     ...
     */
    characteristicWarning(message, type = "warn-message" /* CharacteristicWarningType.WARN_MESSAGE */, stack = new Error().stack, reportWhenUnheard = false) {
        const heard = this.emit("characteristic-warning" /* CharacteristicEventTypes.CHARACTERISTIC_WARNING */, type, message, stack);
