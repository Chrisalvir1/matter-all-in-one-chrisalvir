...
class AccessControl extends Service_1.Service {
    ...
    constructor(displayName, subtype) {
        ...
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.MediaAccessControlLevel);
...
class AccessoryRuntimeInformation extends Service_1.Service {
    ...
    constructor(displayName, subtype) {
        ...
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.ConnectionHealthMonitor);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.HeartBeat);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.SelectedSessionKeepaliveConfigurationList);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.SleepInterval);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.SupportedSessionKeepaliveConfigurationList);
    }
}
 ...
 * @since iOS 27
 */
class CameraBufferManagement extends Service_1.Service {
    static UUID = "00008000-0000-1000-8000-0026BB765291";
    constructor(displayName, subtype) {
        super(displayName, CameraBufferManagement.UUID, subtype);
        // Required Characteristics
        this.addCharacteristic(Characteristic_1.Characteristic.BufferActivityCommand);
        this.addCharacteristic(Characteristic_1.Characteristic.BufferEventCommand);
        this.addCharacteristic(Characteristic_1.Characteristic.BufferEventSequenceNumber);
        this.addCharacteristic(Characteristic_1.Characteristic.BufferUploadCommand);
        this.addCharacteristic(Characteristic_1.Characteristic.CameraRecordingPublishingPoint);
    }
}
exports.CameraBufferManagement = CameraBufferManagement;
Service_1.Service.CameraBufferManagement = CameraBufferManagement;
/**
 * Service "Camera Capabilities"
 * @since iOS 27
 */
class CameraCapabilities extends Service_1.Service {
    static UUID = "00008010-0000-1000-8000-0026BB765291";
    constructor(displayName, subtype) {
        super(displayName, CameraCapabilities.UUID, subtype);
        // Required Characteristics
        this.addCharacteristic(Characteristic_1.Characteristic.CameraCapabilitiesConfiguration);
...
exports.CameraCapabilities = CameraCapabilities;
Service_1.Service.CameraCapabilities = CameraCapabilities;
/**
 * Service "Camera Client Certificate Management"
 * @since iOS 27
 */
class CameraClientCertificateManagement extends Service_1.Service {
    static UUID = "00008080-0000-1000-8000-0026BB765291";
    constructor(displayName, subtype) {
        super(displayName, CameraClientCertificateManagement.UUID, subtype);
        // Required Characteristics
        this.addCharacteristic(Characteristic_1.Characteristic.CameraClientCertificate);
        this.addCharacteristic(Characteristic_1.Characteristic.CameraClientCertificateStatus);
        this.addCharacteristic(Characteristic_1.Characteristic.CameraClientCSR);
    }
}
exports.CameraClientCertificateManagement = CameraClientCertificateManagement;
Service_1.Service.CameraClientCertificateManagement = CameraClientCertificateManagement;
/**
 * Service "Camera Global Operating Mode"
 * @since iOS 27
 */
class CameraGlobalOperatingMode extends Service_1.Service {
    static UUID = "00008032-0000-1000-8000-0026BB765291";
    constructor(displayName, subtype) {
        super(displayName, CameraGlobalOperatingMode.UUID, subtype);
        // Required Characteristics
        this.addCharacteristic(Characteristic_1.Characteristic.CameraOperatingModeIndicator);
        this.addCharacteristic(Characteristic_1.Characteristic.HomeKitCameraActive);
        this.addCharacteristic(Characteristic_1.Characteristic.StreamingEnabled);
        // Optional Characteristics
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.ManuallyDisabled);
...
exports.CameraGlobalOperatingMode = CameraGlobalOperatingMode;
Service_1.Service.CameraGlobalOperatingMode = CameraGlobalOperatingMode;
/**
 * Service "Camera Key Management"
 * @since iOS 27
 */
class CameraKeyManagement extends Service_1.Service {
    static UUID = "00008050-0000-1000-8000-0026BB765291";
    constructor(displayName, subtype) {
        super(displayName, CameraKeyManagement.UUID, subtype);
        // Required Characteristics
        this.addCharacteristic(Characteristic_1.Characteristic.CameraKey);
        this.addCharacteristic(Characteristic_1.Characteristic.CameraKeyID);
    }
}
exports.CameraKeyManagement = CameraKeyManagement;
Service_1.Service.CameraKeyManagement = CameraKeyManagement;
/**
 * Service "Camera Motion Zones"
 * @since iOS 27
 */
class CameraMotionZones extends Service_1.Service {
    static UUID = "00008021-0000-1000-8000-0026BB765291";
    constructor(displayName, subtype) {
        super(displayName, CameraMotionZones.UUID, subtype);
        // Required Characteristics
        this.addCharacteristic(Characteristic_1.Characteristic.Active);
        this.addCharacteristic(Characteristic_1.Characteristic.CameraZones);
        this.addCharacteristic(Characteristic_1.Characteristic.Version);
    }
}
exports.CameraMotionZones = CameraMotionZones;
Service_1.Service.CameraMotionZones = CameraMotionZones;
/**
 * Service "Camera Multi-Tier RTP Stream Management"
 * @since iOS 27
 */
class CameraMultiTierRTPStreamManagement extends Service_1.Service {
    static UUID = "00008031-0000-1000-8000-0026BB765291";
    constructor(displayName, subtype) {
        super(displayName, CameraMultiTierRTPStreamManagement.UUID, subtype);
        // Required Characteristics
        this.addCharacteristic(Characteristic_1.Characteristic.RTPStreamingControl);
        this.addCharacteristic(Characteristic_1.Characteristic.SensorUUID);
        this.addCharacteristic(Characteristic_1.Characteristic.SetupEndpoints);
        this.addCharacteristic(Characteristic_1.Characteristic.StatusActive);
        this.addCharacteristic(Characteristic_1.Characteristic.StreamingEnabled);
        this.addCharacteristic(Characteristic_1.Characteristic.SupportedAudioStreamTiers);
        this.addCharacteristic(Characteristic_1.Characteristic.SupportedRTPConfiguration);
        this.addCharacteristic(Characteristic_1.Characteristic.SupportedVideoStreamTiers);
    }
}
exports.CameraMultiTierRTPStreamManagement = CameraMultiTierRTPStreamManagement;
Service_1.Service.CameraMultiTierRTPStreamManagement = CameraMultiTierRTPStreamManagement;
/**
...
class CameraRecordingManagement extends Service_1.Service {
    ...
    constructor(displayName, subtype) {
        ...
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.SelectedCameraRecordingConfiguration);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.SupportedAudioRecordingConfiguration);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.SupportedCameraRecordingConfiguration);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.SupportedVideoRecordingConfiguration);
    }
}
 ...
 * @since iOS 27
 */
class CameraWebRTCStreamManagement extends Service_1.Service {
    ...
    constructor(displayName, subtype) {
        ...
        this.addCharacteristic(Characteristic_1.Characteristic.SensorUUID);
        this.addCharacteristic(Characteristic_1.Characteristic.StreamingEnabled);
        this.addCharacteristic(Characteristic_1.Characteristic.WebRTCNumberOfActiveSessions);
        this.addCharacteristic(Characteristic_1.Characteristic.WebRTCProvideAnswer);
        this.addCharacteristic(Characteristic_1.Characteristic.WebRTCReoffer);
        this.addCharacteristic(Characteristic_1.Characteristic.WebRTCSolicitOffer);
        this.addCharacteristic(Characteristic_1.Characteristic.WebRTCStreamingControl);
        this.addCharacteristic(Characteristic_1.Characteristic.WebRTCSupportedAudioStreamTiers);
        this.addCharacteristic(Characteristic_1.Characteristic.WebRTCSupportedVideoStreamTiers);
        this.addCharacteristic(Characteristic_1.Characteristic.WebRTCUpdateSession);
    }
}
exports.CameraWebRTCStreamManagement = CameraWebRTCStreamManagement;
Service_1.Service.CameraWebRTCStreamManagement = CameraWebRTCStreamManagement;
/**
...
class FirmwareUpdate extends Service_1.Service {
    ...
    constructor(displayName, subtype) {
        ...
        // Optional Characteristics
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.FirmwareUpdateProtocolList);
...
class MotionSensor extends Service_1.Service {
    ...
    constructor(displayName, subtype) {
        ...
        // Optional Characteristics
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.ContributingSensors);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.MotionEnabled);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.Name);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.StatusActive);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.StatusFault);
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.StatusLowBattery);
...
class WiFiTransport extends Service_1.Service {
    ...
    constructor(displayName, subtype) {
        ...
        // Optional Characteristics
        this.addOptionalCharacteristic(Characteristic_1.Characteristic.PreferredWiFiList);
